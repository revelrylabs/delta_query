defmodule DeltaQuery.PredicateParser do
  ...
  ## Examples
      ...
      iex> DeltaQuery.PredicateParser.parse_predicate("project_id = 123")
      {:ok, {:eq, "project_id", 123}}

      iex> DeltaQuery.PredicateParser.parse_predicate("status != 'closed'")
      {:ok, {:neq, "status", "closed"}}

      iex> DeltaQuery.PredicateParser.parse_predicate("price >= 99.99")
      {:ok, {:gte, "price", 99.99}}

      iex> DeltaQuery.PredicateParser.parse_predicate("active = true")
      {:ok, {:eq, "active", true}}
  """
